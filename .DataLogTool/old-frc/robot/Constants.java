...
public final class Constants {
    ...
    public static final double MECANUM_STRAFE_SPEED_ACCOUNT = 0.82; // The rate at which the robot's strafing velocity differs from forward velocity with the same input
	public static final double MECANUM_ROTATION_SPEED_ACCOUNT = 1.08; // Multiplier for rotation speed to account for the fact that mecanum wheels rotate slower
