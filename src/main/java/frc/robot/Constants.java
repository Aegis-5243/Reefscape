...
public final class Constants {
    ...
    public static final double DRIVE_MAX_ANGULAR_SPEED = 3.2; // 1 sec per 180
    /** Maximum drive angular acceleration in radians per second squared. */
    public static final double DRIVE_MAX_ANGULAR_ACCELERATION = 5.0;
    ...
    public static final double ARM_POSITION_CONVERSION_FACTOR = 360.0 / 25;
    ...
    /* Intake roller positional PID */
    public static final double ROLLER_kP = 0.13;
    public static final double ROLLER_kI = 0;
    public static final double ROLLER_kD = 0.05;

    /* Intake roller velocity feedforwards */
    public static final double ROLLER_kS = 0.1;
