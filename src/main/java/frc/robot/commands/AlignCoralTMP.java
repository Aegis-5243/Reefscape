...
public class AlignCoralTMP extends Command {
     ...
     */
    public AlignCoralTMP(DriveSubsystem driveSubsystem, CameraSubsystem cameraSubsystem) {
     ...
     */
    public AlignCoralTMP(DriveSubsystem driveSubsystem, CameraSubsystem cameraSubsystem, int pipeline) {
     ...
     *                        coral station.
     */
    public AlignCoralTMP(DriveSubsystem driveSubsystem, CameraSubsystem cameraSubsystem, int pipeline, boolean turn) {
